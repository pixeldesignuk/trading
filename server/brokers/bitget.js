...
// Spot balances carry no cost basis, so holding pnl is null.
...
export async function fetchSnapshot(creds, { fetch = globalThis.fetch, now = Date.now, usdGbp, dustGbp = DUST_GBP } = {}) {
  ...
  for (const a of assets || []) {
    ...
    holdings.push({
      ...
      value,
      cost: undefined,
      pnl: undefined, // spot balances carry no cost basis
      currency: 'GBP',
    })
  }
