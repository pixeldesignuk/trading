// Local alert run. Dry-run by default (prints the Telegram message instead of
// sending); pass --send to actually deliver.
//
//   node server/alerts/cli.js            # dry-run
//   node server/alerts/cli.js --send     # real Telegram
